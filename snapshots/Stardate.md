...
- `feedback_ask_before_infra_decisions.md` — [feedback] Ask before infrastructure/environment decisions
- `project_stardate_progress.md` — [project] Stardate project progress
